...
// /RESET clears the timer's load-edge history and counter as well as its flag.
// Leaving these two registers uninitialized makes the first load depend on FPGA
// power-up state (and remain X forever in four-state simulation), which is not
// valid YM2151 reset behavior.
